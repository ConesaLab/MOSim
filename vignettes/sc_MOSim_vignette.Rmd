...
sc_MOSim basic functions. It lets the user simulate scRNA-seq and scATAC-seq 
...
count_matrix <- readRDS("/home/arifebbo/Desktop/Arianna/MOSim/data/example_sc_count_matrix.rds")
...
sim_with_arg <- sc_MOSim(omicsList, cellTypes, numberCells = c(10,20), 
