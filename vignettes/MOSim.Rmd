...
output: pdf_document
vignette: |
  %\VignetteEngine{knitr::knitr} %\VignetteIndexEntry{Wiki of how to use mosim} %\usepackage[utf8]{inputenc}
---
...
\begin{figure}[!tpb]
    ...
    \end{tikzpicture}}%
    \caption{Time profiles representation.}{#fig:profiles}
\end{figure}
...
(https://www.biorxiv.org/content/10.1101/421834v2)
