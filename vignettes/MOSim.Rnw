...
The \Biocpkg{MOSim} package is available from bioconductor at it's 1.1.2 version. It may be installed as:
...
The current development version 1.2.0 is hosted in GitHub, and may be installed as follows:
