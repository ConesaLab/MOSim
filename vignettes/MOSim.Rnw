...
<<code3, echo=TRUE, eval=TRUE, include=FALSE>>=
...
<<code8, echo=TRUE, eval=TRUE, tidy=FALSE, results='hide', message=FALSE>>=
# Select a subset of the available data as a custom dataset
data("sampleData")
...
<<code11, echo=TRUE, eval=TRUE, results='hide', message=FALSE>>=
...
<<code12, echo=TRUE, eval=TRUE, results='hide', message=FALSE>>=
rnaseq_customdata <- omicData("RNA-seq", data = custom_rnaseq)
...
<<code13, echo=TRUE, eval=TRUE, results='hide', message=FALSE>>=
...
<<code14, echo=TRUE, eval=TRUE, tidy=TRUE, results='hide', message=FALSE>>=
...
<<code15, echo=TRUE, eval=TRUE, results='hide', message=FALSE>>=
...
<<code16, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE>>=
...
<<code17, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE>>=
...
<<code18, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE>>=
library(ggplot2)
...
<<code19, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE>>=
...
Martínez-Mira C., Conesa A., Tarazona S. (2018) MOSim: Multi-Omics Simulation in R. DOI: 10.1101/421834
